...
const LinearLoadScreen = () => {
  const { liveData, linearLoadPercentage } = useSettings();
    ...
    <ScrollView style={styles.container}>
      <ExpandableElement
        ...
        expandableContent={
          <View>
            <InfoParameterRow
              name="Nastawa obciążenia liniowego"
              value={`${linearLoadPercentage} %`}
            ></InfoParameterRow>
...
export default LinearLoadScreen;
