...
const WindTurbineScreen = () => {
  const { liveData, windTurbinePercentage } = useSettings();
    ...
    <ScrollView style={styles.container}>
      <ExpandableElement
        ...
        expandableContent={
          <View>
            <InfoParameterRow
              name="Nastawa obciążenia turbiny wiatrowej"
              value={`${windTurbinePercentage} %`}
            ></InfoParameterRow>
...
export default WindTurbineScreen;
